        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    <span className="inline-block text-blue-600 font-bold text-sm tracking-wider uppercase mb-3 bg-blue-600 px-4 py-1.5 rounded-full">
                        こんなお悩みありませんか？
                    </span>
                ...
                {/* Highlight Box */}
                <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 sm:p-12 text-center text-white overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <p className="text-2xl sm:text-3xl font-black mb-4">
                            ディーラーで0円と言われた車も
                            <br />
                            <span className="text-blue-300">全て買い取ります！</span>
                        </p>
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-3 bg-white text-blue-600 font-bold text-lg rounded-xl px-10 py-4 hover:bg-blue-600 transition-colors shadow-lg hover:shadow-xl active:scale-95 transition-transform"
                        >
