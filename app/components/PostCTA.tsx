    ...
    return (
        <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 rounded-2xl p-8 sm:p-12 text-center mt-16 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="tel:050-1724-2478" className="w-full sm:w-auto bg-white/10 hover:bg-white/20 text-white border border-white/30 font-bold px-8 py-4 rounded-full text-lg transition-all duration-300 flex items-center justify-center gap-2">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    050-1724-2478
                </a>
            </div>
            <p className="text-white/70 text-sm mt-5 relative z-10 font-bold tracking-wide">
                <span className="inline-block bg-white/20 px-2.5 py-1 rounded-md mb-1 mr-2 text-white">年中無休</span>
                24時間対応可能・ご相談だけでも大歓迎です！
            </p>
        </div>
    );
}
